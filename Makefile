...
# Project:  Blocks.pro
# Template: app
# Command: C:\Qt\5.5\mingw492_32\bin\qmake.exe -spec win32-g++ "CONFIG+=debug" -o Makefile Blocks.pro
#############################################################################
...
Makefile: Blocks.pro C:/Qt/5.5/mingw492_32/mkspecs/win32-g++/qmake.conf C:/Qt/5.5/mingw492_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ "CONFIG+=debug" -o Makefile Blocks.pro
